        ...
        while td_step['i'][0] < N:
            ...
            if probe_mask.any() and self.cfg.solver.use_theory_trigger:
                ...
                if M > 0:
                    ...
                    is_high_entropy = entropy_rl > entropy_rl.mean().item()-0.05#self.cfg.solver.entropy_threshold
                    ...
                    if current_step_scalar == 0:
                        ...
                        is_high_divergence = kl_divergence > kl_divergence.mean().item()-0.1#-0.2 self.cfg.solver.kl_div_threshold
